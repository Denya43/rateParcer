...
/**
 * ¬еб сервис дл€ получени€ ежедневных данных ver 11.01.2021
 * 
 ...
 * 
 */
@WebServiceClient(name = "DailyInfo", targetNamespace = "http://web.cbr.ru/", wsdlLocation = "file:/E:/Documents/rateParcer/src/main/resources/DailyInfo.asmx.xml")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("file:/E:/Documents/rateParcer/src/main/resources/DailyInfo.asmx.xml");
